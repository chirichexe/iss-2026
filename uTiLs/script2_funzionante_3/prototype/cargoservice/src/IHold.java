...
public interface IHold {
    ...
    String getSlotState(int slotId);
    String doToJson(String serviceState, String workingState, boolean ioPortOccupied, int reservedSlot);
}
