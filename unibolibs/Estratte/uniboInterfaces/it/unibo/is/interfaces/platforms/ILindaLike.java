...
public IMessage select( String subjName, Hashtable<String,Integer> lastMsgRdMemo, List<IMessage> queries ) throws Exception;
public IMessage selectMostRecent( String subjName,Hashtable<String,Integer> lastMsgRdMemo, 
		List<IMessage> queries ) throws Exception;
